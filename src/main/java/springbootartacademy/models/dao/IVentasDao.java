...
@Query("SELECT o FROM Ventas o WHERE CONCAT(o.id,o.usuarios.clientes.nombre,o.usuarios.clientes.telefono) LIKE %?1% order by o.fechaventa, o.estado.nombre DESC")
